		...
		<asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0" >
             ...
             <asp:View ID="View1" runat="server"  > 
                 ...
                 <asp:TableRow>
                      ...
                      <asp:TableRow>
                          <asp:TableCell  CssClass="TableCell">First Name </asp:TableCell>
                       ...
                       <asp:TableRow>
                          <asp:TableCell CssClass="TableCell">Last Name </asp:TableCell>
                          <asp:TableCell CssClass="TableCell">
                            <asp:TextBox ID="lastName" runat="server"></asp:TextBox></asp:TableCell>
                      </asp:TableRow>
                       
                       <asp:TableRow>
                          <asp:TableCell CssClass="TableCell">E-mail </asp:TableCell>
                          <asp:TableCell CssClass="TableCell">
